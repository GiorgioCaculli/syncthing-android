...
import static com.nutomic.syncthingandroid.model.RunConditionCheckResult.BlockerReason.GLOBAL_SYNC_DISABLED;
import static com.nutomic.syncthingandroid.model.RunConditionCheckResult.BlockerReason.NO_ALLOWED_NETWORK;
import static com.nutomic.syncthingandroid.model.RunConditionCheckResult.BlockerReason.NO_MOBILE_CONNECTION;
import static com.nutomic.syncthingandroid.model.RunConditionCheckResult.BlockerReason.NO_NETWORK_OR_FLIGHTMODE;
import static com.nutomic.syncthingandroid.model.RunConditionCheckResult.BlockerReason.NO_WIFI_CONNECTION;
import static com.nutomic.syncthingandroid.model.RunConditionCheckResult.BlockerReason.ON_BATTERY;
import static com.nutomic.syncthingandroid.model.RunConditionCheckResult.BlockerReason.ON_CHARGER;
import static com.nutomic.syncthingandroid.model.RunConditionCheckResult.BlockerReason.POWERSAVING_ENABLED;
import static com.nutomic.syncthingandroid.model.RunConditionCheckResult.BlockerReason.WIFI_SSID_NOT_WHITELISTED;
import static com.nutomic.syncthingandroid.model.RunConditionCheckResult.BlockerReason.WIFI_WIFI_IS_METERED;
import static com.nutomic.syncthingandroid.model.RunConditionCheckResult.SHOULD_RUN;
