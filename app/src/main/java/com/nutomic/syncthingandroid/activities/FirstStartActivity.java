...
public class FirstStartActivity extends Activity
{
    ...
    private static final Slide[] slides = Slide.values();
    ...
    public class ViewPagerAdapter extends PagerAdapter
    {
        ...
        public Object instantiateItem( @NonNull ViewGroup container, int position )
        {
            ...
            switch ( slides[ position ] )
            {
                ...
                case STORAGE:
                    Button btnGrantStoragePerm = view.findViewById( R.id.btnGrantStoragePerm );
                ...
                case LOCATION:
                    Button btnGrantLocationPerm = view.findViewById( R.id.btnGrantLocationPerm );
                ...
                case API_LEVEL_30:
                    ...
                    break;
                case NOTIFICATION:
                    Button notificationBtn = view.findViewById( R.id.btn_notification );
